...
public class BookManagement1 extends javax.swing.JFrame {
    ...
    private JLabel lblBookName, lblPageNo, lblPrice, lblAmount, lblPublishYear,lblType, lblAuthor, lblPublisher, lblLanguage;
	...
	lblTitle.setBounds(518, 10, 150, 40);
	...
	cbbPublishYear.setBounds(336, 80, 123, 20);
        btnBackToDashboard.setBounds(0,0,80,26);
	...
	cbbFindBy.setModel(new DefaultComboBoxModel(new String[] {"Tất cả", "Tên sách", "Tác giả", "Ngôn ngữ", "Năm xuất bản", "Thể loại", "NXB"}));
        ...
        btnBackToDashboard.setBackground(new Color(243, 215, 202));
